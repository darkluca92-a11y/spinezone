...
export function PrimaryContactCTA(props: Omit<ProfessionalContactCTAProps, 'variant'>) {
  return <ProfessionalContactCTA variant="primary" showContactInfo={true} {...props} />;
}

export function PhoneContactCTA(props: Omit<ProfessionalContactCTAProps, 'variant'>) {
  return <ProfessionalContactCTA variant="phone" {...props} />;
}

export function UrgentContactCTA(props: Omit<ProfessionalContactCTAProps, 'variant'>) {
  return <ProfessionalContactCTA variant="urgent" {...props} />;
}

export function QuickContactCTA(props: Omit<ProfessionalContactCTAProps, 'variant'>) {
  return <ProfessionalContactCTA variant="secondary" size="medium" showContactInfo={true} {...props} />;
}
...
export default ProfessionalContactCTA;