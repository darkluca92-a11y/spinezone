...
import LazyLoadWrapper, { LazySectionWrapper, LazyFormWrapper } from '@/components/LazyLoadWrapper';
...
export default function Home() {
  return (
    <main>
      ...
      {/* Below-the-fold lazy-loaded content with optimized loading */}
      <Suspense fallback={
        <div className="bg-gray-50 animate-pulse section-padding" style={{ minHeight: '400px' }}>
          <div className="container-max">
            <div className="h-8 bg-gray-200 rounded mb-4 w-1/3"></div>
            <div className="grid md:grid-cols-3 gap-6">
              {Array.from({ length: 6 }, (_, i) => (
                <div key={`conditions-placeholder-${i}`} className="h-24 bg-gray-200 rounded"></div>
              ))}
            </div>
          </div>
        </div>
      ...
      {/* Contact Form Section - Lazy loaded for performance */}
      <Suspense fallback={
        <div className="section-padding bg-gradient-to-br from-blue-50 via-white to-green-50">
          <div className="container-max">
        ...
        <LazyFormWrapper className="section-padding bg-gradient-to-br from-blue-50 via-white to-green-50">
          <div className="container-max">
            <div className="text-center mb-12">
            ...
            <div className="max-w-2xl mx-auto">
              <LazyLoadWrapper minHeight="500px" preloadDistance="200px">
                <ContactForm />
              </LazyLoadWrapper>
            </div>
          </div>
      ...
      <Suspense fallback={
        ...
        <LazySectionWrapper className="section-padding" sectionHeight="300px">
          <FinalCTA />
        </LazySectionWrapper>
      </Suspense>
      ...
      <Suspense fallback={
            ...
            <div className="container-max">
              <div className="grid md:grid-cols-4 gap-8">
                {Array.from({ length: 4 }, (_, i) => (
                  <div key={`footer-placeholder-${i}`}>
                    <div className="h-6 bg-gray-700 rounded mb-4 w-3/4"></div>
                    <div className="space-y-2">
                      {Array.from({ length: 4 }, (_, j) => (
                        <div key={`footer-placeholder-${i}-${j}`} className="h-4 bg-gray-700 rounded w-1/2"></div>
                      ))}
                    </div>
                  </div>
                ))}
        ...
        <LazySectionWrapper className="bg-gray-900" sectionHeight="250px">
          <Footer />
        </LazySectionWrapper>
      </Suspense>
