...
const POST_SLUG = 'sports-injury-rehabilitation-get-back-in-the-game';
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [
      ...post.tags,
      'SpineZone',
      'San Diego sports injury treatment',
      'athletic rehabilitation',
      'ACL recovery San Diego',
      'sports medicine San Diego'
    ],
    openGraph: {
      title: post.title,
      description: post.excerpt,
        ...
        <div className="container-max">
          <nav className="mb-8" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <li className="text-gray-400">/</li>
              <li className="text-gray-900">Sports Injury Rehabilitation</li>
            </ol>
          </nav>
        ...
        <div className="container-max">
          <div className="max-w-4xl mx-auto">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    {post.author} is a sports medicine specialist and performance coach at SpineZone. 
                    With expertise in athletic rehabilitation and performance enhancement, they help athletes return stronger than ever.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 p-8 bg-gradient-to-r from-blue-600 to-green-600 rounded-2xl text-white text-center">
              <h3 className="text-2xl font-bold mb-4">Ready to Get Back in the Game?</h3>
              <p className="text-xl mb-6 opacity-90">
                Don't let an injury sideline your dreams. Our sports rehabilitation program can help you return stronger.
              </p>
