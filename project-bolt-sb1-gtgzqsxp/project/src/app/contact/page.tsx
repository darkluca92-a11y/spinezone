...
export default function ContactPage() {
  ...
  const handleFormSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        setSubmitMessage('Thank you for contacting SpineZone! We will respond within 24 hours.');
      ...
      <section className="bg-white section-padding">
        <div className="container-max text-center">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            <div className="bg-gray-100 h-96 rounded-2xl overflow-hidden shadow-lg">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3356.8234567890123!2d-117.1611!3d32.7157!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80d954a5ee01234b%3A0x123456789abcdef0!2sDowntown%20San%20Diego%2C%20CA!5e0!3m2!1sen!2sus!4v1635789012345!5m2!1sen!2sus"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                ...
                title="SpineZone Main Location Map"
              />
            </div>
          </div>
        </div>
