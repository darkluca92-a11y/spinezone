      ...
      <main>
        ...
        <section className="bg-white section-padding">
          <div className="container-max">
            ...
            {/* Google Maps Embed */}
            <div className="bg-gray-100 rounded-2xl overflow-hidden shadow-lg mb-12">
              <div className="h-96 lg:h-[500px] relative">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d223901.0589635253!2d-117.3197!3d33.0208!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzPCsDAxJzI3LjAiTiAxMTfCsDE5JzExLjAiVw!5e0!3m2!1sen!2sus!4v1645123456789!5m2!1sen!2sus"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  ...
                  title="SpineZone Clinic Locations Map"
